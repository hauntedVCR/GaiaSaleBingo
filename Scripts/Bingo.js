var bingo = function(bingoList, size) {
	...
	var results = $("#results");
	results.append ("<p id=\"footerInfo\">SRT Bingo <strong>&nbsp;v1</strong>&emsp;Seed: <strong>" + 
	SEED + "</strong>"+"&emsp; Last modified: 8/13/23</p>");// "</strong>&emsp;Card type: <strong>" + cardtype + "</strong></p>");
